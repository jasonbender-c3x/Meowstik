...
CREATE TABLE "voicemails" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "voicemails_recording_sid_unique" UNIQUE("recording_sid")
);
--> statement-breakpoint
...
ALTER TABLE "gemini_caches" ADD CONSTRAINT "gemini_caches_chat_id_chats_id_fk" FOREIGN KEY ("chat_id") REFERENCES "public"."chats"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_call_conversations_recording_sid" ON "call_conversations" USING btree ("recording_sid");--> statement-breakpoint
...
CREATE INDEX "idx_tool_call_logs_status" ON "tool_call_logs" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_voicemails_recording_sid" ON "voicemails" USING btree ("recording_sid");--> statement-breakpoint
CREATE INDEX "idx_voicemails_from_number" ON "voicemails" USING btree ("from_number");--> statement-breakpoint
CREATE INDEX "idx_voicemails_heard" ON "voicemails" USING btree ("heard");