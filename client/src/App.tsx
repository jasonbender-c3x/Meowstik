...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/speech">{() => { window.location.href = '/voice-lab'; return null; }}</Route>
      
      <Route path="/voice-lab">
        {() => <ProtectedRoute><VoiceLabPage /></ProtectedRoute>}
      </Route>
      
      <Route path="/sound-settings">
        {() => <ProtectedRoute><SoundSettingsPage /></ProtectedRoute>}
      </Route>
  ...
  return (
    ...
    <QueryClientProvider client={queryClient}>
      ...
      <TTSProvider>
        ...
        {/* LocalDriveProvider: Provides local folder access via File System Access API */}
        <LocalDriveProvider>
