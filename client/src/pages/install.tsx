...
export default function InstallPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col" data-testid="install-page">
      {/* Header */}
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h1 className="text-xl font-semibold flex items-center gap-2">
              ...
              Install Meowstik Tools
            </h1>
            <p className="text-sm text-muted-foreground">
              Browser extension and desktop agent • Get started in minutes
            </p>
          </div>
        </div>
      </header>
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                  <div className="border border-border rounded-lg bg-muted/20 p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <h3 className="font-semibold">Meowstik AI Assistant</h3>
                  ...
                  <div className="border border-border rounded-lg bg-muted/20 p-6">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">Load the extension in developer mode</p>
                    <ol className="space-y-4 text-sm">
                      ...
                      <li className="flex gap-3">
                        <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground text-xs font-semibold">4</span>
                        <div>
                      ...
                      <li className="flex gap-3">
                        <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground text-xs font-semibold">5</span>
                        <div>
                      ...
                      <li className="flex gap-3">
                        <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground text-xs font-semibold">6</span>
                        <div>
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                  <div className="border border-border rounded-lg bg-muted/20 p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <h3 className="font-semibold">Meowstik Desktop Agent</h3>
                        <p className="text-sm text-muted-foreground">Full desktop control for AI collaboration</p>
                      </div>
                    </div>
                  ...
                  <div className="border border-border rounded-lg bg-muted/20 p-6">
                    <h3 className="font-semibold mb-4">Quick Install (npm)</h3>
                    <p className="text-sm text-muted-foreground mb-4">Install via npm or run with npx</p>
