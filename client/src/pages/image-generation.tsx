...
export default function ImageGenerationPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col" data-testid="page-image-generation">
      {/* Header */}
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground">
              Create and edit images with AI • Canvas drawing and generation tools
            </p>
          </div>
        </div>
      </header>
          ...
          <main className="max-w-7xl mx-auto p-6 w-full">
            <div className="grid lg:grid-cols-[1fr_350px] gap-6">
              <div className="space-y-4">
                <div className="border border-border rounded-lg bg-muted/20 p-6">
                  ...
                  <div className="flex gap-4">
                    <div className="flex flex-col gap-2 p-2 bg-muted/20 border border-border rounded-lg">
                      <Button
              ...
              <div className="space-y-4">
                ...
                <div className="border border-border rounded-lg bg-muted/20 p-6">
                  <h3 className="text-base font-semibold mb-4">Canvas Info</h3>
