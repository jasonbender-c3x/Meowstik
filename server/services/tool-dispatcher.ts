...
export class ToolDispatcher {
  ...
  private async executeSearch(toolCall: ToolCall, messageId: string): Promise<unknown> {
    throw new Error("RAG Search functionality has been removed.");
  }
  ...
  private async executeFileOperation(toolCall: ToolCall, messageId: string): Promise<unknown> {
    throw new Error("RAG File Ingestion functionality has been removed.");
  }
